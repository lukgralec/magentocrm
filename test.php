...
//
//$url = "http://sugarcrm.dev/service/v4_1/rest.php";
//$username = "admin";
//$password = "m4t3m4tyk4";
//
...
//
//$svnumbers_array=  array();
//echo '<pre>';
//$result_count = $get_entry_list_result->result_count;
//for ($i = 0; $i < $result_count; $i++) {
//    $svnumber = $get_entry_list_result->entry_list[$i]->name_value_list->svnumber->value;
//    array_push($svnumbers_array,$svnumber); 
//}
//
//print_r($svnumbers_array);
//echo '</pre>';
